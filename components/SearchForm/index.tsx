...
type SearchFormProps = {
    ...
    onSearchRemoved?: () => void;
    className?: string;
    placeholder?: string;
}

export const SearchForm = ({ onSearch, className, onType, placeholder, onSearchRemoved }: SearchFormProps) => {
    ...
    return (
        <form onSubmit={handleSubmit} className={className}>
            ...
            <div className="relative">
                ...
                <input type="search" ref={searchInput} onChange={handleChange} id="default-search" className="block p-4 pl-10 w-full text-sm text-gray-900 card rounded-lg border border-teal-500 focus:ring-blue-500 focus:border-blue-500 card dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder={ placeholder || "Search name, chain Id..." } required />
